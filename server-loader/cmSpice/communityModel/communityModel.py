...
# Community detection
from cmSpice.community_module.community_detection.explainedCommunitiesDetection import ExplainedCommunitiesDetection

# similarity measures
from cmSpice.community_module.similarity.complexSimilarityDAO import ComplexSimilarityDAO
from cmSpice.community_module.similarity.interactionSimilarityDAO import InteractionSimilarityDAO
...
class CommunityModel():
    ...
    def clusteringOLD(self):
        ...
        algorithmFile = "cmSpice.community_module.community_detection." + algorithmName 
